...
// Filter categories based on input
    ...
    const handleCreateProduct = async () => {
        // Changed validation to check categoryInput instead of productCategory
        ...
        try {
            const response = await fetch("/api/products", {
                ...
                body: JSON.stringify({
                    ...
                    shop: productShop,
                    // ⭐ CHANGED: Send categorySlug instead of category ID
            ...
            if (data.success) {
                ...
                setProductShop("")
                setProductCategory("")
                // ⭐ NEW: Clear category input
                setCategoryInput("")
                setSelectedProductImages([])
                // ⭐ NEW: Refresh categories if a new one was created
